...
if __name__=='__main__':
    ...
    network_order_path = os.path.join(root_path,'data/Amazon_HydroSHEDS_river_networks/Amazon_river_network_rasterized_by_order.tif')
    network_da_path = os.path.join(root_path,'data/Amazon_HydroSHEDS_river_networks/Amazon_river_network_rasterized_by_drainage_area.tif')
    ...
    if SAMPLE_METHOD == 'RANDOM':
        ...
        sample_df.to_csv(os.path.join(root_path,f'data/Amazon_HydroSHEDS_river_networks/network_points_{SAMPLE_LENGTH}_{SAMPLE_METHOD}.csv'))
